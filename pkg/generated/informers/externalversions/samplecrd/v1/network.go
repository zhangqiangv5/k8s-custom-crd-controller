...
import (
	context "context"
	apissamplecrdv1 "k8s-custom-crd-controller/pkg/apis/samplecrd/v1"
	versioned "k8s-custom-crd-controller/pkg/generated/clientset/versioned"
	internalinterfaces "k8s-custom-crd-controller/pkg/generated/informers/externalversions/internalinterfaces"
	samplecrdv1 "k8s-custom-crd-controller/pkg/generated/listers/samplecrd/v1"
	time "time"
...
type NetworkInformer interface {
	...
	Lister() samplecrdv1.NetworkLister
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apissamplecrdv1.Network{}, f.defaultInformer)
}

func (f *networkInformer) Lister() samplecrdv1.NetworkLister {
	return samplecrdv1.NewNetworkLister(f.Informer().GetIndexer())
}
